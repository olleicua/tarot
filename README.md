A flexible tarot CLI for people who whose interests include tarot, making tarot decks, and command line interfaces

## Installation / Usage

```
git clone git@github.com:olleicua/tarot.git
cd tarot
bin/tarot commands
```
